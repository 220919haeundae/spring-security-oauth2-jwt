...
public class JWTUtil {
    ...
    public JWTUtil(@Value("${spring.jwt.secret}")String secet) {

        secretKey = new SecretKeySpec(secet.getBytes(StandardCharsets.UTF_8), Jwts.SIG.HS256.key().build().getAlgorithm());
